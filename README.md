...
Como rodar
Abrir a classe BarApplication.java.
Clicar com o botão direito.
Selecionar Run As > Java Application.
...
O ponto principal é: **cada bloco de código precisa abrir e fechar com três crases**. No seu print, parece que um bloco abriu antes
